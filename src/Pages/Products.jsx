    ...
    <>
      <div className='bg-slate-800'>
        ...
        <header className=' flex items-start justify-between  text-white  p-3 max-w-6xl mx-auto z-20 xl:items-center'>
          {/**left side */}
          <div>
            <Link to="/food" className='capitalize hover:underline cursor-pointer '>
              food safety
            </Link>
          </div>
          <div>
          ...
          <div className='flex flex-wrap flex-row justify-center items-center gap-7 pt-20'>
            ...
            <div className='shadow-md w-[58vh] h-[80vh] rounded'>
              ...
              <div className='pt-5 px-4'>
                <p className='capitalize text-sm text-gray-400 font-normal'>
            ...
            <div className='shadow-md rounded w-[58vh] h-[80vh]'>
              <img
                src='https://img.freepik.com/premium-photo/pomegranate-juice-pomegranate-fruit_210632-180.jpg'
                alt=' '
                className='w-[100%] h-64 object-cover rounded'
              />
              <div></div>
            ...
            <div className='shadow-md rounded w-[58vh] h-[80vh]'>
              <img
                src='https://credofarms.com/wp-content/uploads/2021/07/frozen-blueberries.jpg'
                alt=' '
                className='w-[100%] h-64 object-cover rounded'
              />
              <div></div>
            ...
            <div className='shadow-md rounded w-[58vh] h-[80vh]'>
              <img
                src='https://img.freepik.com/premium-photo/bowl-fruit-with-green-leaf-it_865967-20455.jpg'
                alt=' '
                className='w-[100%] h-64 object-cover rounded'
              />
              <div></div>
            ...
            <div className='shadow-md rounded w-[58vh] h-[80vh]'>
              <img
                src='https://www.grunge.com/img/gallery/the-truth-about-the-supreme-court-case-that-declared-tomatoes-vegetables/intro-1643844067.jpg'
                alt=' '
                className='w-[100%] h-64 object-cover rounded'
              />
              <div></div>
            ...
            <div className='shadow-md rounded w-[58vh] h-[80vh]'>
              <img
                src='https://manilasun.com/wp-content/uploads/2020/09/calamansi-1024x614.jpeg'
                alt=' '
                className='w-[100%] h-64 object-cover rounded'
              />
              <div></div>
